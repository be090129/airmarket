class Admin::OrdersController < Admin::AdminController
  ...
  private
    ...
    def order_params
      params.require(:order).permit(:validate_terms_date, :terms, :start_date, :end_date, :order_price, :listing_id,:buyer_id, :seller_id, :status, :message, :check_payin, :check_payout, :fees_buyer, :validated_time, :fees_seller, :order_payout, :mangopay_transaction_id,:mangopay_payout_id )
    end
end
